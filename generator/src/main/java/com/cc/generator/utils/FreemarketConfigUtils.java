...
public class FreemarketConfigUtils {
    ...
    public final static int TYPE_SERVICEIMPL = 2;
    public final static int TYPE_SERVICE = 5;
    public final static int TYPE_CONTROLLER = 3;
    public final static int TYPE_MAPPER = 4;
    public final static int TYPE_VIEW = 6;
    public final static int TYPE_ENTITY_CUSTOM = 7;
