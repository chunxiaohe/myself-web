        ...
        <#--<a href="#" class="w_logo"></a>-->
            <span class="w_header_nav">
					<ul>
						...
						<li><a href="${webRoot}/back/page/login">管理登录</a></li>
					</ul>
				</span>
            <div class="w_search">
        ...
        <div class="row w_main_row">
                    ...
                    <div id="w_carousel" class="carousel slide w_carousel" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img src="${staticRoot}/blog/img/slider/slide1.jpg" alt="...">
                            ...
                            <div class="item">
                                <img src="${staticRoot}/blog/img/slider/slide2.jpg" alt="...">
                                <div class="carousel-caption">...</div>
                            </div>
                            <div class="item">
                                <img src="${staticRoot}/blog/img/slider/slide3.jpg" alt="...">
                                <div class="carousel-caption">...</div>
                            </div>
                            <div class="item">
                                <img src="${staticRoot}/blog/img/slider/slide4.jpg" alt="...">
                                <div class="carousel-caption">...</div>
                            </div>
                        </div>
                                    ...
                                    <div class="contentImage">
                                        <div class="row">
                                            <a href="#" class="thumbnail w_thumbnail">
                                                <img src="${staticRoot}/blog/img/slider/Aj6bieY.jpg" alt="...">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="contentImage">
                                        ...
                                        <div class="row">
                                            <a href="#" class="thumbnail w_thumbnail">
                                                <img src="${staticRoot}/blog/img/slider/abs_img_no.jpg" alt="...">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="contentImage">
                                        ...
                                        <div class="row">
                                            <a href="#" class="thumbnail w_thumbnail">
                                                <img src="${staticRoot}/blog/img/slider/67zmaej.png" alt="...">
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-lg-3 col-md-3 w_main_right">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="list-unstyled sidebar">
                            ...
                            <li>
                                <a href="/post/20654391">使用 redis 和 spring-session 实现 tomcat、glassfish 等 web 服务器集群
                                    session 共享</a>
                            </li>
                            <li>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <img src="${staticRoot}/blog/img/qrcode.jpg" style="height: 230.5px;width: 230.5px;"/>
                    </div>
                </div>
