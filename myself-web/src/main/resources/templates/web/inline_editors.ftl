...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="${staticRoot}/templateForPage/js/bootstrap-wysihtml5/bootstrap-wysihtml5.css" />
...
<script type="text/javascript" src="${staticRoot}/templateForPage/js/ckeditor/ckeditor.js"></script>
