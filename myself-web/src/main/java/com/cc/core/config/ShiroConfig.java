...
import com.cc.core.shiro.ShiroSessionDao;
import com.cc.core.shiro.ShiroSessionListener;
import com.cc.core.shiro.UserRealm;
import com.cc.core.util.ApplicationContextUtil;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        //写的测试接口不拦截
        filterMap.put("/demo/page/**", "anon");
        filterMap.put("/demo/api/**", "anon");
